      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-[3rem] p-8 md:p-16 shadow-sm border border-border">
          <div className="text-center mb-16">
            ...
            <p className="text-[#6B4B4B] text-lg max-w-2xl mx-auto">
          ...
          <div className="space-y-12 text-[#3B2725] leading-relaxed">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-[#FFF9E8] p-8 rounded-2xl">
                <h3 className="font-bold text-xl mb-3">Chất lượng hàng đầu</h3>
                <p className="text-[#6B4B4B] text-sm">Từ phôi ly thủy tinh chịu nhiệt Borosilicate đến công nghệ in decal nung nhiệt độ cao, mọi sản phẩm của Cupfy đều được kiểm tra nghiêm ngặt để đảm bảo an toàn tuyệt đối cho sức khỏe người dùng.</p>
              </div>
              <div className="bg-[#FFEDA8] p-8 rounded-2xl">
                <h3 className="font-bold text-xl mb-3">Sáng tạo không giới hạn</h3>
                <p className="text-[#6B4B4B] text-sm">Giao diện thiết kế 3D trực quan giúp bạn dễ dàng thêm chữ, hình ảnh, thay đổi màu sắc và xem trước sản phẩm thực tế ở mọi góc độ một cách chân thực nhất.</p>
              </div>
            </div>
