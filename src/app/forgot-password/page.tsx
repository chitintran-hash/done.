  ...
  return (
    <div className="min-h-screen bg-[#FFF9E8] flex items-center justify-center p-6">
      <div className="w-full max-w-md bg-white border border-[#EAE7DE] rounded-2xl p-8 shadow-sm">
        <h1 className="text-3xl font-bold mb-2 text-[#181818]">Quên mật khẩu</h1>
        ...
        {message ? (
          ...
          <form onSubmit={handleReset} className="space-y-4">
            <div>
              <label className="block text-sm font-medium mb-1 text-[#181818]">Email</label>
              <input 
                type="email" 
                required
                value={email}
            ...
            <p className="text-center text-sm text-muted-foreground pt-4">
              Nhớ mật khẩu? <Link href="/login" className="text-[#181818] font-bold hover:underline">Đăng nhập</Link>
            </p>
          </form>
        )}
      </div>
