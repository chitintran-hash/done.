  ...
  return (
    <div className="min-h-screen pt-[120px] pb-24 bg-[#FFF9E8]">
      <div className="container mx-auto px-6">
        ...
        {/* Hero */}
        <div className="bg-[#FFEDA8] rounded-[3rem] p-12 md:p-20 flex flex-col md:flex-row items-center gap-12 mb-24">
          <div className="w-full md:w-1/2">
            ...
            <p className="text-[#6B4B4B] text-lg mb-8 max-w-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
          {[
            ...
            <div key={idx} className="bg-white p-8 rounded-3xl text-center shadow-sm border border-border">
              <div className="w-16 h-16 bg-[#FFF9E8] rounded-full flex items-center justify-center mx-auto mb-6 text-[#D9788F]">
                <feat.icon className="w-8 h-8" />
              </div>
              <h3 className="font-bold text-xl text-[#3B2725] mb-4">{feat.title}</h3>
              <p className="text-[#6B4B4B]">{feat.desc}</p>
            </div>
          ))}
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-[#6B4B4B] mb-8">Liên hệ trực tiếp với chúng tôi để nhận báo giá tốt nhất cho đơn hàng số lượng lớn.</p>
